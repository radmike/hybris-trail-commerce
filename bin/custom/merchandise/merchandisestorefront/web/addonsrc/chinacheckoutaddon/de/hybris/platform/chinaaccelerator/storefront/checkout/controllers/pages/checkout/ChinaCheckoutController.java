...
public class ChinaCheckoutController extends MultiStepCheckoutController
{
	...
	public List<CheckoutSteps> addCheckoutStepsToModel(final HttpServletRequest request)
	{
		...
		checkoutSteps.add(new CheckoutSteps("step2", "/checkout/multi/step2"));
		...
		if (!getCheckoutFacade().containsTaxValues())
		{
			LOG.error(String
					.format(
							...
							cartData.getCode()));
			GlobalMessages.addFlashMessage(rediectmodel, GlobalMessages.ERROR_MESSAGES_HOLDER, "checkout.error.tax.missing");
			invalid = true;
		}
