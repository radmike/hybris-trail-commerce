 ...
 *  
 */
package com.radmike.merchandise.chinastorefront.tags;
...
public class Functions
{
	 ...
	 * merchandisestorefront.lazyload is set to true. Else the HTML image tag is being created and returned as it
	...
	{
		if (getConfigurationService(getCurrentRequest()).getConfiguration().getBoolean("merchandisestorefront.lazyload",
				false))
		{
			return new StringBuilder("<img class=\"" + cssClass + "\" src=\"" + placeholderMediaUrl + "\" data-original=\""
					+ mediaUrl + "\" width=\"100%\"><noscript><img title=\"" + mediaAltTextAndTitle + "\" alt=\""
