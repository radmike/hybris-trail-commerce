 ...
 * 
 */
package com.radmike.merchandise.storefront.interceptors.beforeview;

import de.hybris.platform.acceleratorservices.enums.UiExperienceLevel;
import de.hybris.platform.acceleratorservices.storefront.data.MetaElementData;
import de.hybris.platform.acceleratorservices.uiexperience.UiExperienceService;
import com.radmike.merchandise.storefront.interceptors.BeforeViewHandler;
...
public class UiExperienceMetadataViewHandler implements BeforeViewHandler
{
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.radmike.merchandise.storefront.interceptors.BeforeViewHandler#beforeView(javax.servlet.http.
